...
import { r as normalizeReferral } from "./referral-BDKQ5Mjn.mjs";
...
import { l as isTicketTypeId, t as EVENT } from "./event-IC9aXe9Q.mjs";
import { n as ensureDbReady, r as getPglite } from "./db-CRz4B43v.mjs";
...
import { $t as getBetterAuthVersion, A as decodeProtectedHeader, At as literal, C as toResponse, Dt as array, E as filterOutputFields, Et as any, Ft as record, Gt as ATTR_OPERATION_ID, Ht as withSpan, It as string, Jt as getAuthTables, Kt as import_src, Lt as union, M as jwtVerify, Mt as number, Nt as object, O as base64Url, Ot as boolean, Pt as optional, Qt as runWithTransaction, S as createRouter$1, T as serializeSignedCookie, Ut as ATTR_CONTEXT, Wt as ATTR_HOOK_TYPE, Xt as queueAfterTransactionHook, Yt as getCurrentAdapter, Zt as runWithAdapter, _ as defineRequestState, _n as BASE_ERROR_CODES, a as betterFetch, an as logger, b as getCurrentAuthContext, c as isLoopbackHost, cn as env, d as getIp, dn as isDevelopment, en as initGetModelName, f as deprecate, fn as isProduction, g as isAPIError, gn as kAPIErrorHeaderSymbol, h as createAuthMiddleware, hn as BetterAuthError, i as refreshAccessToken, in as createLogger, j as importJWK, jt as looseObject, k as decodeJwt, kt as email, l as createRateLimitKey, m as createAuthEndpoint, mn as APIError, n as socialProviders, nn as generateId, o as createAuthorizationURL, on as shouldPublishLog, p as normalizePathname, pn as isTest, pt as JWTExpired, qt as safeJSONParse, r as validateAuthorizationCode, rn as createRandomStringGenerator, s as applyDefaultAccessTokenExpiry, t as SocialProviderListEnum, tn as initGetFieldName, tt as encode, u as findInvalidTrustedProxies, v as hasRequestState, vn as defineErrorCodes, w as serializeCookie, x as runWithEndpointContext, y as runWithRequestState } from "../_libs/@better-auth/core+[...].mjs";
import { c as Menu, r as TriangleAlert, t as X } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-er0R-en-.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: friendlyMessage(error)
			})
		]
	});
}
...
function MainLogo({ className, to = "/" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		...
		"aria-label": EVENT.logos.main.alt,
		children: img
	});
}
function PartnerLogos({ className, compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("flex flex-wrap items-center gap-3 sm:gap-5", className),
		children: EVENT.logos.partners.map((logo) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			src: logo.src,
			alt: logo.alt,
			className: cn("w-auto object-contain object-left", "onLight" in logo && logo.onLight && "bg-white p-1.5", "wide" in logo && logo.wide ? compact ? "h-8 max-w-[10.5rem] sm:h-9 sm:max-w-[13rem]" : "h-10 max-w-[13rem] sm:h-12 sm:max-w-[16rem]" : compact ? "h-9 sm:h-11" : "h-11 sm:h-14")
		}, logo.src))
	});
}
...
function SocialLinks({ className, compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: EVENT.socials.map((item) => {
			const Mark = marks[item.id];
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				href: item.href,
				target: "_blank",
				rel: "noreferrer",
				className: cn("inline-flex items-center gap-2.5 rounded-full border border-border bg-card/70 text-foreground transition-colors duration-150 hover:border-accent hover:text-accent", compact ? "h-10 px-3" : "h-11 px-4"),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mark, { className: "size-4 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex flex-col leading-none",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[10px] uppercase tracking-[0.16em] text-muted-foreground",
						children: item.label
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn("mt-0.5 font-medium", compact ? "text-xs" : "text-sm"),
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-12 sm:px-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MainLogo, { className: "h-14 sm:h-16" }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-5 text-[11px] uppercase tracking-[0.18em] text-muted-foreground",
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PartnerLogos, { className: "mt-3" })] })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "text-sm text-muted-foreground",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "VIP dan Festival: QRIS statis." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1",
						children: [
							"Usia ",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/admin",
							className: "text-muted-foreground/70 underline-offset-4 hover:underline",
							children: "Admin"
						})
					})
				]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MainLogo, {})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
...
var styles_default = "/assets/styles-DisSXc63.css";
...
var Route$17 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Golden Satya Fair 2026 — tiket VIP dan Festival di Perumahan Golden Star Lumina Bumiayu."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter$14 = () => import("./routes-CVw64DNW.mjs");
var Route$16 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$14, "component") });
var $$splitComponentImporter$13 = () => import("./route-DAOctvqO.mjs");
var Route$15 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./checkout-Gv-Vm6bm.mjs");
var Route$14 = createFileRoute("/checkout")({
	validateSearch: (s) => {
		const type = isTicketTypeId(String(s.type ?? "")) ? s.type : void 0;
...
var $$splitComponentImporter$11 = () => import("./login-VhQJTbPL.mjs");
...
var $$splitComponentImporter$10 = () => import("./tiket-DIJ1iM48.mjs");
var Route$12 = createFileRoute("/tiket")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./admin-xt0HST3s.mjs");
var Route$11 = createFileRoute("/admin/")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./agent-CASProQO.mjs");
var Route$10 = createFileRoute("/admin/agent")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./crew-DoqWWua7.mjs");
var Route$9 = createFileRoute("/admin/crew")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./pembayaran-CWd8aoX3.mjs");
var Route$8 = createFileRoute("/admin/pembayaran")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./pengguna-FLF-sVrK.mjs");
var Route$7 = createFileRoute("/admin/pengguna")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./tiket-DAfcd_Uv.mjs");
var Route$6 = createFileRoute("/admin/tiket")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./transaksi-BaeSYgpe.mjs");
var Route$5 = createFileRoute("/admin/transaksi")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./order._orderId-CEJbv-yV.mjs");
var Route$4 = createFileRoute("/order/$orderId")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./tiket._code-lRb05XdW.mjs");
var Route$3 = createFileRoute("/tiket/$code")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
/**
...
var Route$1 = createFileRoute("/api/midtrans/notification")({ server: { handlers: {
	...
	POST: async ({ request }) => {
		...
		try {
			if (contentType.includes("application/x-www-form-urlencoded")) (await request.formData()).forEach((value, key) => {
		...
		const { verifyAndReadNotification } = await import("./midtrans.server-BMbxrYey.mjs");
		const { getSql } = await import("./db-CRz4B43v.mjs").then((n) => n.t);
		const { applyMidtransNotification } = await import("./server-N4SKNTPJ.mjs");
		...
		if (!verified.ok) return new Response(verified.reason, { status: verified.reason === "forbidden" ? 403 : 400 });
		await applyMidtransNotification(await getSql(), verified.orderId, {
			paid: verified.paid,
...
var $$splitComponentImporter = () => import("./order._orderId.konfirmasi-U3bzhblo.mjs");
var Route = createFileRoute("/order/$orderId/konfirmasi")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var TiketRoute = Route$12.update({
	id: "/tiket",
	path: "/tiket",
	getParentRoute: () => Route$17
});
...
var AdminAgentRoute = Route$10.update({
	id: "/agent",
	path: "/agent",
	getParentRoute: () => AdminRouteRoute
});
var AdminCrewRoute = Route$9.update({
	id: "/crew",
	path: "/crew",
	getParentRoute: () => AdminRouteRoute
});
var AdminPembayaranRoute = Route$8.update({
	id: "/pembayaran",
	path: "/pembayaran",
	getParentRoute: () => AdminRouteRoute
});
var AdminPenggunaRoute = Route$7.update({
	id: "/pengguna",
	path: "/pengguna",
	getParentRoute: () => AdminRouteRoute
});
var AdminTiketRoute = Route$6.update({
	id: "/tiket",
	path: "/tiket",
	getParentRoute: () => AdminRouteRoute
});
var AdminTransaksiRoute = Route$5.update({
	id: "/transaksi",
	path: "/transaksi",
	getParentRoute: () => AdminRouteRoute
});
var OrderOrderIdRoute = Route$4.update({
	id: "/order/$orderId",
	path: "/order/$orderId",
	getParentRoute: () => Route$17
});
var TiketCodeRoute = Route$3.update({
	id: "/$code",
	path: "/$code",
...
var ApiMidtransNotificationRoute = Route$1.update({
	id: "/api/midtrans/notification",
	path: "/api/midtrans/notification",
	getParentRoute: () => Route$17
});
var OrderOrderIdKonfirmasiRoute = Route.update({
	id: "/konfirmasi",
	path: "/konfirmasi",
...
var TiketRouteWithChildren = TiketRoute._addFileChildren(TiketRouteChildren);
var OrderOrderIdRouteChildren = { OrderOrderIdKonfirmasiRoute };
var rootRouteChildren = {
	...
	OrderOrderIdRoute: OrderOrderIdRoute._addFileChildren(OrderOrderIdRouteChildren),
	ApiAuthSplatRoute,
...
//#endregion
export { Route$13 as a, MainLogo as c, Route$4 as i, PartnerLogos as l, Route as n, Route$14 as o, Route$3 as r, SocialLinks as s, router_exports as t };
